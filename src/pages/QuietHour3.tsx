...
// ============================================================
// /quiet-hour-3 — A/B variant of /quiet-hour.
// Identical copy + layout; the only difference vs the control
// is that the 3 product photos (journal-in-lap, Ruth spread,
// Ecclesiastes spread) are wrapped in outbound <a> tags so
// taps on product images route to the offer. Clarity reports
// ~1.8 dead clicks per pageview on the control — this variant
// tests whether making product photos clickable reduces that
// and lifts CTR.
// ============================================================
      ...
      <article>
        ...
        <div className="wrap body">
          ...
          <figure className="fig">
            <a
              href={buildOutboundUrl()}
              data-cta="image-outbound"
              target="_blank"
              rel="sponsored noopener noreferrer"
              aria-label="A woman in a cream cable-knit sweater holds a brown leather Bible Study Guide journal in her lap, with a small plant on a wooden table behind her."
          ...
          <div className="spread-grid">
            <figure className="fig">
              <a
                ...
                target="_blank"
                rel="sponsored noopener noreferrer"
                aria-label="Open Bible Study Guide journal on a wooden table, showing the Ruth study spread with key themes, symbolism, and reflection prompts."
                style={{ display: "block", cursor: "pointer" }}
              >
                <img
                  loading="lazy"
            ...
            <figure className="fig">
              <a
                ...
                target="_blank"
                rel="sponsored noopener noreferrer"
                aria-label="Open Bible Study Guide journal on a soft cream cloth, showing the Ecclesiastes study spread with the same gentle scaffolding."
                style={{ display: "block", cursor: "pointer" }}
              >
                <img
                  loading="lazy"
